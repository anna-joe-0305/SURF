%% SET ELONGATIONSLAENGE BGA
directory = "E:\Stockholm Marz 2019\";
folders = [ "BGA\BGA 5mum Standard 25mulh_20190319_133319\";
    "BGA\BGA 5mum 2EL 25mulh_20190319_143028\";
    "BGA\BGA 5mum 3EL 25mulh_20190319_150141\"];
stenosis_end_x = [725;% "BGA\BGA 5mum Standard 25mulh_20190319_133319\";
    925;% "BGA\BGA 5mum 2EL 25mulh_20190319_143028\";
    1035];% "BGA\BGA 5mum 3EL 25mulh_20190319_150141\";
...
for z=1:size(folders,1)
    ...
    for bin_nr = 2:6
        ...
        if ~isempty(rosettes_sorted_undamaged{bin_nr})
            ...
            hold on;
            [m,mind]=min(abs(800-(velocities_forfit(:,1))));
            ...
            if maxv>4* median(gauss(fitpara_vel(bin_nr,:),xevenly))
                velok(bin_nr, 1) = 1;
    ...
    for bin_nr = 3:6
        ...
        if velok(bin_nr) &&~isempty(rosettes_sorted_undamaged{bin_nr})
            ...
            [m,mind]=min(abs(700-(minoraxisvsx(:,1))));%nur werte bis 700 um zweite stenose zu vermeiden
            ...
            med_def= mean(minoraxisvsx(1:5,2));%lieber mean?
